...
Polygon::Polygon(Eigen::ArrayXd x, Eigen::ArrayXd y) {
    // Is polygon closed?
...
std::vector<Line> Polygon::lines() const {
...
std::vector<Edge> Polygon::sort_edges() const {
...
std::vector<Span> Polygon::get_spans(double const y) const {
    using namespace ranges;
...
std::vector<RasterLine> Polygon::raster(double dy) const {
    using namespace ranges;
